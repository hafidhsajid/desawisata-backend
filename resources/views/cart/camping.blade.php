...
<body>
    <nav class="navbar navbar-light">
        <div class="container d-block">
            ...
            <button  class="btn btn-secondary rounded-pill" onclick="goBack()" class=""><i class="bi bi-chevron-left"></i> Kembali</button>
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <div class="form-body">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="position-relative">
                                    ...
                                    <?php
                                    $hargamakan = App\Models\Camp::where('tempat_id',$camping["tempat_id"] )->where('kategori','makan')->pluck('harga')->first();
                    ...
                    @else
                    Langung Datang Sajaa , Tempatnya Gratis kok
                    @endif
                    @endforeach
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-content">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="{{ url('/transaksi/tambah/camping') }} " method="POST" enctype="multipart/form-data" class="form form-horizontal">
                            @csrf
                            <div class="col-12  d-flex justify-content-end">
                                <div class="form-group">

                                    <input type="hidden" id="first-name-column" class="form-control" name="total" value="{{ $total }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="durasii" value="{{ $durasii }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="tempat_name" value="{{ $tempat_name }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="jumlah_orang" value="{{ $jumlah_orang }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="makan" value="{{ $makan }}" >
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit"
