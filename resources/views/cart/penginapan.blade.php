            ...
            <div class="card-body">
                ...
                <div class="card-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="penginapan">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/cart/hapus/penginapan/'.$key) }}"> Batal </a>
                                    </td>
                        ...
                        <form action="{{ url('/transaksi/tambah/booking') }} " method="POST" enctype="multipart/form-data" class="form form-horizontal">
                            @csrf
                            <div class="col-12  d-flex justify-content-end">
                                <div class="form-group">
                                    <input type="hidden" id="first-name-column" class="form-control" name="total" value="{{ $grandtotal }}" >
                                    ...
                                    <input type="hidden" id="first-name-column" class="form-control" name="checkin" value="{{ $checkin }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="checkout" value="{{ $checkout }}" >
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit"
