                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                {{ $ca->deskripsi }}  Rp. {{ number_format($ca->harga) }}  {{ $ca->deskripsi_harga }}
                            </p>
                        </div>
                    </div>
                             ...
                             date_default_timezone_set('Asia/Jakarta');
                              ...
                              for ($i = 0; $i < $durasi; $i++) {
                               $eventtgl = date('Y-m-d ', strtotime('+' . $i . 'day', strtotime($checkin)));
                                // dd($eventtgl);
                               $booked = App\Models\EventCamping::where('date', $eventtgl)->where('tempat_id', $tempat_id)->where('title',"booked")->where('camp_id', $ca->kode_camp)->exists();
                            ...
                            //   dd($booked)
                              ?>
                                ...
                                @else
                                    ...
                                    <form action="{{url('/cart/tambah/camp/'.$ca->kode_camp) }} " method="GET" enctype="multipart/form-data">
                                    @csrf


                                    <input type="hidden" id="first-name-column" class="form-control" name="durasi" value="{{ $durasi }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="tempat_id" value="{{ $tempat_id }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="tanggal_a" value="{{ ($formatted_dt1) }}" >
                                    <input type="hidden" id="first-name-column" class="form-control" name="tanggal_b" value="{{ $formatted_dt2 }}" >
