                ...
                <div class="home__container container grid">
                    ...
                    <div class="home__info">
                        <div>
                            ...
                            <a href="{{ url('/event',[$tempat->slug]) }}" class="button button--flex button--link home__info-button">
                ...
                <div class="experience__container container grid">
                    <div class="experience__content grid">
                        <div class="experience__data">
                            <h2 class="experience__number">{{App\Models\Wahana::where('tempat_id', $tempat->id)->where('harga','!=',0)->count()}}+</h2>
            ...
            <section class="about section" id="camp">
                <div class="about__container container grid">
                    <div class="about__data">
                        <h2 class="section__title about__title"> Di {{ $tempat->name }}<br>  Ada Camping Ground lho</h2>
                        <p class="about__description"> Langsung saja tekan tombol mau camping
                        </p>
                        <a href="{{url('/mau/camping/'.$tempat->id) }}" class="button">Mau Camping !</a>
                    </div>
                ...
                <div class="discover__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="discover__card swiper-slide">
                            ...
                            <form action="{{url('/cart/tambah/'.$whn->kode_wahana) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="tempat_id"  value="{{  $tempat->id }}">
                                <input  type="hidden" name="durasi" class="form-control"  id="durasi"  value="1" required>
                                <input type="hidden" name="kategori"  value="wahana">
                                <input  name="jumlah" class="form-control" type="number" id="jumlah Pesan" placeholder="Jumlah" required>
