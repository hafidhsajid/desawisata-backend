            ...
            <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{url('/pilihcamping/'.$id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="datefield2"  name="date2"
                                                            class="form-control @error('date') is-invalid @enderror" required>
                ...
                <nav class="navbar navbar-light">
                    <div class="container d-block">
                        ...
                        <button class="btn btn-secondary rounded-pill" onclick="goBack()" class=""><i class="bi bi-chevron-left"></i> Back</button>
