    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Halaman untuk mengelola data pelanggan</p>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            @if($users->status==1)
                                            <a href="{{route('update.status.pelanggan',[$users->id])}}"><button class="btn btn-warning"> Active</button></a>
                                            @else
                                            <a href="{{route('update.status.pelanggan',[$users->id])}}"><button class="btn btn-danger"> Inactive</button></a>
                                            @endif
                                        </td>
                                        {{-- <td>
                                            @if($users->status==1)
                                        ...
                                        <td>
                                            <a href="{{route('pelanggan.edit',[$users->id])}}">
