            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="{{route('admin.update',[$users->id])}} " method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                        ...
                                                        <select class="form-select" id="basicSelect"  name="desa_id">
                                                            <option value=""    @if ($users->desa_id== null) selected @endif >Please select desa </option>

                                                        @foreach(App\Models\Tempat::get()->where('kategori','desa') as $desad)
                                                        <option value="{{$desad->id}}" @if($users->desa_id==$desad->id)selected @endif > {{$desad->name}}</option>
                                                        @endforeach
                                                        </select>
