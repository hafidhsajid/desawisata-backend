                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                                ...
                                <form action="{{ route('kegiatan.store')}} " method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                    @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group ">
                                                <div class="position-relative">
                                                    <input type="text" hidden name="tempat_id" value="{{ $tempat->id }}">
                                                    <input type="text" hidden name="user_id" value="{{ Auth::user()->id }}">
                                                    <input type="text" hidden name="kode_kegiatan" value="{{ $kode_kegiatan }}">
                                                    {{ $tempat->name}}
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                                        placeholder="Nama kegiatan" id="first-name-icon" value="{{ old('name') }}" required>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input  name="jumlah" class="form-control" type="text" id="rupiah" placeholder="Harga" >
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" id="jb" name="jambuka" class="form-control @error('jambuka') is-invalid @enderror" value="{{ old('jambuka') }}" >
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" id="jt" name="jamtutup" class="form-control @error('jamtutup') is-invalid @enderror" value="{{ old('jamtutup') }}" >
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="number" class="form-control @error('kapasitas') is-invalid @enderror" name="kapasitas"
