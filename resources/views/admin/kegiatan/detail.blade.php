...
<div class="page-content">
    <section class="section">
                ...
                <div class="card" >
                    ...
                    <div class="card-content">
                        ...
                        <div class="breadcrumb breadcrumb-right">
                            <a   href="{{ route('kegiatan.index') }}"> <button class="btn btn-outline-secondary me-1 mb-1">Back</button></a>
                            <a   data-bs-toggle="modal" data-bs-target="#peserta"> <button class="btn btn-outline-secondary me-1 mb-1">Peserta</button></a>
                            <a   data-bs-toggle="modal" data-bs-target="#default"> <button class="btn btn-outline-primary me-1 mb-1">Update </button></a>
                        </div>
     ...
     <div class="card-body">
        ...
        <div class="modal fade text-left" id="default" tabindex="-1" aria-labelledby="myModalLabel1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <form class="form form-horizontal" action="{{route('kegiatan.update',[$kegiatan->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control" name="name" value="{{ $kegiatan->name }}" >
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input  name="harga" class="form-control" type="text" id="rupiah" placeholder="Harga" value="{{ $kegiatan->harga }}" >
                                            <div class="form-control-icon">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="time" id="jb" name="jambuka" class="form-control @error('jambuka') is-invalid @enderror" value="{{ $kegiatan->jambuka }}" >
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="time" id="jt" name="jamtutup" class="form-control @error('jamtutup') is-invalid @enderror" value="{{ $kegiatan->jamtutup }}" >
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" class="form-control" name="kapasitas" value="{{ $kegiatan->kapasitas }}" >
                                        </div>
                                    </div>
                                </div>
        ...
        <!--Basic Modal -->
        <div class="modal fade text-left" id="peserta" tabindex="-1" aria-labelledby="myModalLabel1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
