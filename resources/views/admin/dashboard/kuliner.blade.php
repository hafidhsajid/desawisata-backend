...
@section('title', 'Admin Kuliner Page')
    ...
    <section class="row">
        <div class="col-12 col-lg-12">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Makanan</h6>

                                    <h6 class="font-extrabold mb-0"> {{App\Models\Kuliner::where('tempat_id',$tempatt->id)->count()}} </h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php
                $today= date('Y-m-d');
                $data = App\Models\Detail_transaksi::where('tanggal_a', $today)->where('kategori', 'kuliner')->where('tempat_id', $tempatt->id)->get();
                ?>
                <div class="col-6 col-lg-3 col-md-6">
                  <a href="{{ route('todaykuliner.index') }}" >
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
