                    ...
                    <div class="card-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-right">
                                <li class="breadcrumb-item">    <a href="{{route('tempat.create')}}" class="btn btn-outline-primary ">Tambah Tempat </a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            @if($users->status==1)
                                            <a href="{{route('update.status.tempat',[$users->id])}}"><button class="btn btn-warning"> Active</button></a>
                                            @else
                                            <a href="{{route('update.status.tempat',[$users->id])}}"><button class="btn btn-danger"> Inactive</button></a>
                                            @endif
                                        </td>
                                        {{-- <td>
                                            @if($users->status==1)
                                        ...
                                        <td>
                                            <a href="{{route('tempat.edit',[$users->id])}}">
