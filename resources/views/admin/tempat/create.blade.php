                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                                ...
                                <form action="{{ route('tempat.store')}} " method="POST" enctype="multipart/form-data" class="form form-vertical">
                                    @csrf
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <div class="position-relative">
                                                    <fieldset class="form-group">
                                                        <select class="form-select" name="kategori" required>
                                                            ...
                                                            <option value="hotel"> Tempat Hotel</option>
                                                ...
                                                <div class="position-relative">
                                                    <fieldset class="form-group">
                                                        <select class="form-select" id="basicSelect"  name="induk_id" >
                                                            ...
                                                            <option selected value=''>Pilih Induk Tempat</option>
                                                            @foreach(App\Models\Tempat::where('kategori','desa')->get() as $induk)
                                                                <option value="{{$induk->id}}">  {{$induk->name}}</option>
                                                            @endforeach
