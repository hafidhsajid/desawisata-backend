...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
    ...
    <body>
        ...
        <div clas="card">
            ...
            <form action="{{ route('payment.update',[$kode]) }} " method="POST" enctype="multipart/form-data" class="form form-horizontal">
                @csrf


                <input type="hidden" name="status_message"  value="{{  $transaction_status }}"></div>
                <input type="hidden" name="order_id"  value="{{ $result->order_id }}"></div>
                <input type="hidden" name="payment_type"  value="{{ $result->payment_type }}"></div>
