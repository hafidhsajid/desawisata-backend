    ...
    <div class="card" data-bs-toggle="modal" data-bs-target="#default2">
        <div class="card-content">
            @if(Auth::user()->image == null)
             ...
             <img src="{{asset('images')}}/user.jpg" class="card-img-top img-fluid"
             alt="singleminded">
              @else
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <button type="submit"
                                    class="btn btn-primary me-1 mb-1"  data-bs-toggle="modal" data-bs-target="#default">Update</button>
                                {{-- <button type="reset"
                            ...
                            <div class="card-body px-3 py-4-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">     <?php $cancel = (App\Models\Tiket::where('user_id', Auth::user()->id)->where('check',"cancel")->count()) + (App\Models\Tiket::where('user_id', Auth::user()->id)->where('check',"expire")->count()) ?> {{ $cancel }}</h6>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
...
<div class="card-body">
                                    ...
                                    <div class="position-relative">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-select"  name="jk" required>
                                                <option value=""    @if (Auth::user()->jk== null) selected @endif >Pilih gender</option>
    ...
    <div class="modal fade text-left" id="default2" tabindex="-1" aria-labelledby="myModalLabel1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                <form class="form form-horizontal" action="{{route('profile.update2',[Auth::user()->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row">
