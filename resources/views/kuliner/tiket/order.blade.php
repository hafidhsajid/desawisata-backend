                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0">{{App\Models\Detail_transaksi::where('tempat_id', $id)->count()}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0">{{App\Models\Detail_transaksi::where('tempat_id', $id)->where('status', null)->count()}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0">{{App\Models\Detail_transaksi::where('tempat_id', $id)->where('status',1)->count()}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
