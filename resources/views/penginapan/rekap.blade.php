...
<div class="card-body">
    <div class="card-header">
        ...
        <br>
        <br>
        <a href="{{ url('/penginapan/rekapp/print/'.$default) }}" onclick="return confirm('Mau di Print ?')"><i class="fas fa-print" style="font-size: 30px;"></i></span> </a>
        &nbsp;    &nbsp;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php
                      ...
                      $db2 = App\Models\EventBooking::where('kode_tiket', $data->kode_tiket)->where('title','Booked')->get();
                      $db3 = App\Models\EventBooking::where('kode_tiket', $data->kode_tiket)->where('title','Booked')->get();
                    ?>
                    <td>
                        {{ $value->jumlah_orang }}
                    </td>
