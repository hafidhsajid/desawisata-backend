                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                                ...
                                <form action="{{ route('kamar.store')}} " method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                    @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    ...
                                                    <input type="name" class="form-control"  name="kode_kamar" value="{{ $kode_kamar }}" disabled d>
                                                    <input type="text" name="kode_kamar" value="{{ $kode_kamar }}" hidden>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="position-relative">
                                                    <fieldset class="form-group">
                                                        <select class="form-select"  name="tempat_id">
                                                            ...
                                                            <option selected value=''>Pilih tempat penginapan</option>
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                                        placeholder="Nama Kamar" id="first-name-icon" value="{{ old('name') }}" required>
