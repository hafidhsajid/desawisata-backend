        ...
        <header class="mb-5">
            <div class="header-top">
                ...
                <div class="logo">
                    ...
                    <a href="{{ route('logout') }}">
                        <button class="btn btn-outline-primary me-1 mb-1" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</button>
                            ...
                            <div class="submenu ">
                                ...
                                <div class="submenu-group-wrapper">
                                        ...
                                        <li class="submenu-item  ">
                                            <a href="{{ url('/event',[$value->slug]) }}" class='submenu-link'>{{ $value->name }}</a>
                                        </li>
                                        @endif
