...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!-- favicon img -->
		<link rel="shortcut icon" type="image/icon" href="{{ asset('assets/images/favicon/lungo.png') }}"/>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-2">
							<div class="logo">
								<a href="{{ url('/') }}">
									<i class="fa fa-map-marker"></i> Lungo.<span></span>
								</a>
							</div><!-- /.logo-->
						</div><!-- /.col-->
						<div class="col-sm-10">
			...
			<div class="container">
				...
				<div class="service-counter text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<img src="{{ asset('./vendor/tour/assets/images/service/s2.png') }}" alt="service-icon" />
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="statistics-img">
								<img src="{{ asset('./vendor/tour/assets/images/service/s3.png') }}" alt="service-icon" />
        ...
        <section id="spo" class="packages">
			<div class="container">
				...
				<div class="gallary-header text-center ">
                    ...
                    <p>
                        <li class="breadcrumb breadcrumb-right text-center ">    <a href="{{ url('/pesanan/all') }}" class="btn btn-outline-primary "> Semua Pesanananku</a></li>
                    </p>
				</div><!--/.gallery-header-->
							...
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<p>
												<i class="fa fa-angle-right"></i>   <a href="{{ url('/pesanan/detail/'.$tiket->kode) }}"> Detail Pesanan </a>
										</p>
									</div><!--/.packages-para-->
                                    @if ($tiket->status == 0)
                                    ...
                                    @if ($tiket->status == 0)
                                    @else
                                        <a href="{{url('bayar/status',[$tiket->kode])}}"><button class="btn  btn-outline-info"><i class="fas fa-search"></i></button>
                                    @endif
			...
			<div class="container">
				...
				<div class="foot-icons ">
					<ul class="footer-social-links list-inline list-unstyled">
		                ...
		                <li><a href="https://www.instagram.com/alifudinniko/" target="_blank" class="foot-icon-bg-3"><i class="fa fa-instagram"></i></a></li>
		        	</ul>
