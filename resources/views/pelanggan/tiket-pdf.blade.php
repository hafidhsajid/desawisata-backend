...
<br>
            ...
            <table id="meta">
                ...
                <tr>
                    ...
                    <td>{{ substr(App\Models\detail_transaksi::where('kode_tiket', $tiket->kode)->pluck('tanggal_a')->first(),0,10) }}</td>
                </tr>

                <tr>
                    <td class="meta-head">Amount Due</td>
                    <td><div class="due">Rp. {{ number_format($tiket->harga) }}</div></td>
                </tr>
		...
		<table id="items">
          ...
          <tr>
            ...
            <td class="total-value"><div id="subtotal">Rp. {{ number_format($tiket->harga) }}</div></td>
        </tr>
        <tr>
            <td colspan="2" class="blank"> </td>
            <td colspan="2" class="total-line">Amount Paid</td>

            <td class="total-value"><textarea id="paid">Rp. {{ number_format($tiket->harga) }}</textarea></td>
        </tr>

		  {{-- <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance">Balance Due</td>
		      <td class="total-value balance"><div class="due">Rp. {{ number_format($tiket->harga) }}</div></td>
		  </tr> --}}
