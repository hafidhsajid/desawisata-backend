...
<div class="col-12 col-md-6 col-lg-6">
    ...
    <form action="/adesa/rekapd" method="post">
        @csrf
...
<div class="card-body">
    <div class="card-header">
        ...
        <br>
        <br>
        <a href="{{ url('/adesa/rekapd/print/'.$default) }}" onclick="return confirm('Mau di Print ?')"><i class="fas fa-print" style="font-size: 30px;"></i></span> </a>
        &nbsp;    &nbsp;
